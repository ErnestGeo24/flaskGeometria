...
def geo():
    ...
    if "Area" in geometria and "Diagonale" in geometria:
        ...
        return render_template('result_43.html',Area=area, Diagonale = diagonale)
    elif "Diagonale" in geometria:
        diagonale = math.sqrt(base ** 2 + altezza ** 2)
        return render_template("result_42.html", Diagonale = diagonale)
    elif "Area" in geometria:
      area = base * altezza
      return render_template("result_41.html", Area = area)
    else:
      return render_template("result_40.html")
